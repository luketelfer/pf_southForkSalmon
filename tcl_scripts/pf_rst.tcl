...
#------------------------------------------------------------------------------------------------
file copy -force ../${rst_name}/${rst_name}.out.press.${rst_time}.pfb press.init.pfb
#------------------------------------------------------------------------------------------------
file copy -force ../../../pfpostproc/calc_test.tcl .
file copy -force ../../../pfpostproc/pf.py .
