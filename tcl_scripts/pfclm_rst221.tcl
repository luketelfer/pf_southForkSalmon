...
#------------------------------------------------------------------------------------------------
set basedir [pwd]
set batchname spinup
set runname [lindex $argv 0]
set rst_name [lindex $argv 1]
...
file copy -force ${basedir}/input_files/domain_inputs/pfspin_indicator.pfb ${runname}_indicator.pfb
#------------------------------------------------------------------------------------------------
file copy -force ${basedir}/input_files/domain_inputs/drv_vegp.dat .
file copy -force ${basedir}/input_files/domain_inputs/drv_vegm.dat .
file copy -force ${basedir}/input_files/domain_inputs/restart_clmin.dat drv_clmin.dat
#------------------------------------------------------------------------------------------------
file copy -force ../${rst_name}/${rst_name}.out.press.08760.pfb press.init.pfb
file copy -force ../${rst_name}/clm.rst.00000.0 .
file copy -force ../${rst_name}/clm.rst.00000.1 .
file copy -force ../${rst_name}/clm.rst.00000.2 .
file copy -force ../${rst_name}/clm.rst.00000.3 .
#------------------------------------------------------------------------------------------------
puts "Files Copied"
#------------------------------------------------------------------------------------------------
...
file copy -force ${basedir}/pfpostproc/spinup.py .
file copy -force ${basedir}/pfpostproc/pfpostproc .
file copy -force ${basedir}/pfpostproc/postproc.bash .
#-----------------------------------------------------------------------------
