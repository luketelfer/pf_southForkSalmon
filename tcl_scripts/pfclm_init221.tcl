...
# 2. SET PROCESSORS
#----------------------------------
pfset Process.Topology.P $proc_num1
pfset Process.Topology.Q $proc_num2
pfset Process.Topology.R $proc_num3
#----------------------------------
...
# 3. SETUP RUN DIRECTORY
#------------------------------------------------------------------------------------------------
set batchname spinup/221
set runname [lindex $argv 0]
cd output_files/${batchname}
file mkdir $runname 
cd $runname
#------------------------------------------------------------------------------------------------
file copy -force ../../../../input_files/domain_inputs/sfs_slopex.pfb .
file copy -force ../../../../input_files/domain_inputs/sfs_slopey.pfb .
file copy -force ../../../../input_files/domain_inputs/sfs.pfsol .
file copy -force ../../../../input_files/domain_inputs/pfspin_indicator.pfb ${runname}_indicator.pfb
#------------------------------------------------------------------------------------------------
file copy -force ../../../../input_files/domain_inputs/drv_vegp.dat .
file copy -force ../../../../input_files/domain_inputs/drv_vegm.dat .
file copy -force ../../../../input_files/domain_inputs/initial_clmin.dat drv_clmin.dat
#------------------------------------------------------------------------------------------------
file copy -force ../../../../input_files/domain_inputs/clmspin_press_init.pfb press.init.pfb
#------------------------------------------------------------------------------------------------
puts "Files Copied"
#------------------------------------------------------------------------------------------------
...
pfset Solver.CLM.CLMDumpInterval              $clm_dump
pfset NetCDF.WriteCLM                         True
pfset NetCDF.CLMNumStepsPerFile               $netcdf_filesize
...
pfset Solver.CLM.ReuseCount                   $wrf_reuse
#------------------------------------------------------------------------------------------------
pfset Solver.CLM.MetFileName                  WRF
pfset Solver.CLM.MetFilePath                  ../../../../input_files/wrf_2006/dist_${proc_num1}${proc_num2}${proc_num3}/
...
# 30. GET POSTPROC FILES
#-----------------------------------------------------------------------------
file copy -force ../../../../input_files/domain_inputs/sfs_dem.tif .
file copy -force ../../../../input_files/domain_inputs/johnsoncreek2006.csv .
file copy -force ../../../../input_files/domain_inputs/krassel2006.csv .
file copy -force ../../../../pfpostproc/spinup.py .
file copy -force ../../../../pfpostproc/pfpostproc .
#-----------------------------------------------------------------------------
